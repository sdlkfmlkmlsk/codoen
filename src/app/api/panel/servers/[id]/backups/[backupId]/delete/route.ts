...
export async function DELETE(req: Request, props: { params: Promise<{ id: string, backupId: string }> }) {
    try {
        ...
        await pteroClient(`/api/client/servers/${serverId}/backups/${backupId}`, adminClientToken, {
            method: "DELETE"
        });
