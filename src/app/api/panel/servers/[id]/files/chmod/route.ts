...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { root: string, files: [{ file: string, mode: string }] }
        ...
        await pteroClient(`/api/client/servers/${serverId}/files/chmod`, adminClientToken, {
            method: "POST",
        ...
        console.error("Chmod file error:", error.message);
