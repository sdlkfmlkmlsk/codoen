...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { root: string, files: string[] }
        ...
        await pteroClient(`/api/client/servers/${serverId}/files/compress`, adminClientToken, {
            method: "POST",
        ...
        console.error("Compress file error:", error.message);
