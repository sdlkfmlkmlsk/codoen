...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { root: string, file: string }
        ...
        await pteroClient(`/api/client/servers/${serverId}/files/decompress`, adminClientToken, {
            method: "POST",
        ...
        console.error("Decompress file error:", error.message);
