...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const { root, files } = await req.json(); // Expected: { root: string, files: string[] }
        ...
        await pteroClient(`/api/client/servers/${serverId}/files/delete`, adminClientToken, {
            method: "POST",
        ...
        console.error("Delete files error:", error.message);
