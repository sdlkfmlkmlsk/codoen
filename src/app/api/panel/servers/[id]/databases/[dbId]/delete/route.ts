...
export async function DELETE(req: Request, props: { params: Promise<{ id: string, dbId: string }> }) {
    try {
        ...
        await pteroClient(`/api/client/servers/${serverId}/databases/${dbId}`, adminClientToken, {
            method: "DELETE"
        });
