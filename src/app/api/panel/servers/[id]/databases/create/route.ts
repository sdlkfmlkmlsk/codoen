...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { database: string, remote: string }
        ...
        await pteroClient(`/api/client/servers/${serverId}/databases`, adminClientToken, {
            method: "POST",
        ...
        console.error("Databases create error:", error.message);
