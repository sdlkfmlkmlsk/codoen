...
export async function PUT(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { docker_image: string }
        ...
        await pteroClient(`/api/client/servers/${serverId}/settings/docker-image`, adminClientToken, {
            method: "PUT",
        ...
        console.error("Startup image update error:", error.message);
