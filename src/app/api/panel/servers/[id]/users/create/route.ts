...
export async function POST(req: Request, props: { params: Promise<{ id: string }> }) {
    try {
        ...
        const body = await req.json(); // Expected: { email: string, permissions: string[] }
        ...
        await pteroClient(`/api/client/servers/${serverId}/users`, adminClientToken, {
            method: "POST",
        ...
        console.error("Subuser create error:", error.message);
