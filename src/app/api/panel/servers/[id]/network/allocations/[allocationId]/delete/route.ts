...
export async function DELETE(req: Request, props: { params: Promise<{ id: string, allocationId: string }> }) {
    try {
        ...
        await pteroClient(`/api/client/servers/${serverId}/network/allocations/${allocationId}`, adminClientToken, {
            method: "DELETE"
        });
